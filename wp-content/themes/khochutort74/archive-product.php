...
<!-- section-catalog -->
<section class="section section-catalog single-page">
  <div class="container">
      ...
      <nav class="catalog-nav">
        ...
        <ul class="catalog-nav__wrapper">
          ...
          <?php foreach ($catalog_nav_items as $item) : ?>
            <li class="catalog-nav__item">
              <a href="<?php echo get_site_url() . '/product-categories/' . $item->slug; ?>" class="catalog-nav__btn" data-filter="<?php echo $item->slug; ?>"><?php echo $item->name; ?></a>
            </li>
          <?php endforeach; ?>

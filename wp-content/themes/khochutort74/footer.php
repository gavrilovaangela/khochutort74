    ...
    <div class="popup__inner">
      <div class="popup__content popup__content--fluid popup__content--centered">
        ...
        <div class="phone popup__phone">
          <a class="phone__item phone__item--accent" href="tel:<?php echo $GLOBALS['khochutort']['phone_digits'] ?>"><?php echo $GLOBALS['khochutort']['phone'] ?></a>
        </div>
        <ul class="socials">
  ...
  <div class="popup__wrapper">
    <div class="popup__inner">
      <div class="popup__content">
        ...
        <p class="popup__subtitle popup__subtitle--order"></p>
        <div class="order">
          ...
          <form class="form form-send">
            ...
            <input class="form__input" type="text" name="адрес доставки" placeholder="Адрес доставки" required>
            <input class="form__input" type="datetime-local" name="дата и время" placeholder="Дата и время доставки" required>
            <select class="form__input" name="начинка">
              <option value="Выбор начинки">Выбор начинки</option>
              <option value="Черничный мусс">Черничный мусс</option>
              <option value="Мокко">Мокко</option>
              <option value="Йогуртовая">Йогуртовая</option>
              <option value="Сметанная">Сметанная</option>
            ...
            <input class="form__input" type="text" name="комментарий к заказу" placeholder="Комментарий к заказу" required>
            <input type="checkbox" id="politics" onclick="check();" value="" autocomplete="off"/>
Нажимая на кнопку "Отправить", я даю <a href="<?php echo get_template_directory_uri(); ?>/assets/docs/politika.pdf">согласие на обработку персональных данных.</a>
            <button class="btn form__btn" type="submit" name="submit" disabled="">Отправить</button>
          </form>
          <script>
          function check() {
...
<div class="popup popup-thanks">
  <div class="popup__wrapper">
    <div class="popup__inner">
      <div class="popup__content">
        <button class="btn-close popup__btn-close popup-close"></button>
        <h2 class="page-title popup__title">Спасибо за Ваш заказ!</h2>
        <p class="popup__subtitle">Для подтверждения заказа администратор свяжется с Вами в ближайшее время.</p>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="popup__wrapper">
    <div class="popup__inner">
      <div class="popup__content">
        ...
        <p class="popup__subtitle">Пожалуйста, сделайте заказ по номеру <a class="popup__link" href="<?php echo $GLOBALS['khochutort']['phone_digits'] ?>"><?php echo $GLOBALS['khochutort']['phone'] ?></a></p>
      </div>
    </div>
  </div>
</div>

...
add_action('wp_ajax_send_email', 'khochutort_send_email');
add_action('wp_ajax_nopriv_send_email', 'khochutort_send_email');
function khochutort_send_email() {
  ...
  $admin_email = 'khochutort74@gmail.com';
  $form_subject = 'Заявка с сайта KhochuTort';
  $message = '';

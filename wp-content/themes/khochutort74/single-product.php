  ...
  <div class="container single-page__container">
    <?php if ( have_posts() ) : ?>
        <div class="single-page__content">
          <div class="product">
            <picture>
              <source type="image/webp" style="width: 350px;height: 400px;" srcset="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-srcset="<?php echo $product_img_src; ?>">
              <img class="product__img lazy" style="width: 350px;height: 400px;" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-src="<?php echo $product_img_src; ?>" alt="">
            </picture>
